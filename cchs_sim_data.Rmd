...
Histogram display the sum of each 500 bootstrap weights, with \textcolor{blue}{blue} indicates the sum of sample weights. This is to check whether bootstrap weights already include the sample weights, which seem to be true.
...
btstrpSum <- colSums(cchs2013_14_Ontario[bootstrapVars])
